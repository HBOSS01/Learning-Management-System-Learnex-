...
namespace LMS
{
    public partial class Manage_Faculty: Form
    {
        ...
        public Manage_Faculty(string adminUsername)
        {
            InitializeComponent();
        ...
        private void dataView()
        {
            ...
            {
                string query = "SELECT * FROM LMS_TeacherFullDetails";
...
//inserting datas
            private void insertData_Click(object sender, EventArgs e)
            {
                ...
                DateTime joiningDate = joiningDatePicker.Value;
            ...
            private void ClearFields()
        {
            ...
            richTextBox5.Clear();
            richTextBox6.Clear();
            joiningDatePicker.Value = DateTime.Today;
        }
...
//Updateting Datas
        private void updateButton_Click(object sender, EventArgs e)
        {
            ...
            int teId = Convert.ToInt32(dataGridView1.SelectedRows[0].Cells["TE_ID"].Value);
            ...
            using (SqlConnection con = DbConnection.GetConnection())
            {
                ...
                try
                {
                    ...
                    string updateQuery = "UPDATE LMS_Teachers SET ";
                    bool somethingToUpdate = false;

                    if (!string.IsNullOrWhiteSpace(name))
                    {
                        updateQuery += "Te_Name = @name, ";
                        cmd.Parameters.AddWithValue("@name", name);
                    ...
                    {
                        updateQuery += "Te_Username = @username, ";
                        cmd.Parameters.AddWithValue("@username", username);
                        somethingToUpdate = true;
                    }
                    ...
                    if (!string.IsNullOrWhiteSpace(password))
                    {
                        updateQuery += "Te_Password = @password, ";
                        cmd.Parameters.AddWithValue("@password", password);
                        somethingToUpdate = true;
                    }
                    ...
                    {
                        updateQuery += "Te_Email = @email, ";
                        cmd.Parameters.AddWithValue("@email", email);
                        somethingToUpdate = true;
                    }

                    if (joiningDatePicker.Checked)
                    {
                        updateQuery += "Joining_Date = @joinDate, ";
                        cmd.Parameters.AddWithValue("@joinDate", joiningDate);
                        somethingToUpdate = true;
                    }
                    ...
                    if (!string.IsNullOrWhiteSpace(phone))
                    {
                        string updatePhoneQuery = "UPDATE LMS_TeacherPhone SET TE_PNUMBER = @phone WHERE Te_ID = @id";
...
//deleteting Data
        private void deleteButton_Click(object sender, EventArgs e)
        {
            ...
            string username = dataGridView1.SelectedRows[0].Cells["TE_Username"].Value.ToString();
            ...
            using (SqlConnection con = DbConnection.GetConnection())
            {
                string query = "DELETE FROM LMS_Teachers WHERE TE_Username = @username";
...
//Search for data
        private void SearchButton_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection con = DbConnection.GetConnection())
            {
                string query = "SELECT * FROM LMS_TeacherFullDetails WHERE Te_Username = @username";
        ...
        private void Manage_Faculty_Load(object sender, EventArgs e)
        {
            dataView();
        }
        ...
        private void joiningDatePicker_ValueChanged(object sender, EventArgs e)
        {
